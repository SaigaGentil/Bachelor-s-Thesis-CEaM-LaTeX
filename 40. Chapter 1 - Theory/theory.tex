...
As one can see from the design, the proposed UAV consists of about 5 main components. Starting from the top going clockwise they are:
\begin{itemize}
