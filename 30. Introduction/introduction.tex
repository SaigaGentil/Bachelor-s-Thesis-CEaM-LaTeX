...
HelloSky group is a company name that I came up with to label my work done and future developments that will be made on this project and many other related projects that will be built in the future. HelloSky group in itself was thought as a group company that will have multiple child companies, and in the scope of this project, it will be used to represent the part of the company that is envisioned to deal with aerial mobility, hence being the scope of the thesis. Figure \ref{fig:hs-group-logos} shows the HelloSky group logos used throughout the thesis project.
