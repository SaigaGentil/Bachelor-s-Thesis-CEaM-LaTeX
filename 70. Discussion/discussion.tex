...
\begin{figure}[H]
    \centering \includegraphics[width=1\linewidth]{cloud_watch_vpc_flow_log_log_groups.png}
...
\begin{figure}[H]
    \centering \includegraphics[width=1\linewidth]{cloud_watch_vpc_flow_log_log_events.png}
...
\begin{figure}[H]
    \centering \includegraphics[width=1\linewidth]{cloud_watch_vpc_flow_log_logs_insights.png}
