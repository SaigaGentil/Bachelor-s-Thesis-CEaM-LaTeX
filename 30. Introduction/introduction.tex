...
\begin{figure}[!htbp]
    ...
    \caption{Proposed solution high-level design. [Own work. Designed with Affinity Designer. Refer to \ref{subsec:affinity-designer}.]}
...
\begin{figure}[!htbp]
    ...
    \end{subfigure}
    \caption{HelloSky group logos. [Own work. Designed with Affinity Designer. Refer to \ref{subsec:affinity-designer}.]}
